...
#define DMAT_MIN_BRIGHTNESS		LEDMAT_MIN_BRIGHTNESS
#define DMAT_MAX_BRIGHTNESS		LEDMAT_MAX_BRIGHTNESS
#define DMAT_DEFAULT_BRIGHTNESS	LEDMAT_DEFAULT_BRIGHTNESS
